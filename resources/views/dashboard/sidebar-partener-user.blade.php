...
<div id="left-sidebar" class="sidebar">
    <div class="sidebar-scroll">
        <div class="user-account">
            <img src="{{ asset('/theme-assets/images/user.png') }}" class="rounded-circle user-photo" alt="User Profile Picture">
            <div class="dropdown">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        <li class="{{ isActive('dashboard/*') }}">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-home"></i> <span>لــــوحة التحكم</span></a>
                            <ul>
                                <li class="{{ isActive('dashboard/analytic') }}"><a href="{{ url('/dashboard/analytic') }}">تحــليل</a></li>
                            </ul>
                        </li>
                        <li class="{{ isActive('companies/*') }}">
                            <a href="#App" class="has-arrow"><i class="fa fa-building-o" aria-hidden="true"></i> <span>الشركة </span></a>
                            <ul>
                                <li class="{{ isActive('companies/create') }}"><a href="{{ url('companies/create') }}">بينات الشركة </a></li>
                                <li class="{{ isActive('company-images/create') }}"><a href="{{ url('company-images/create') }}">أضافة صور</a></li>
                                <li class="{{ isActive('company-images') }}"><a href="{{ url('company-images') }}">عرض جميع الصور</a></li>
                            </ul>
                        </li>
                        <li class="{{ isActive('offers/*') }}">
                            <a href="#FileManager" class="has-arrow"><i class="fa fa-gift" aria-hidden="true"></i> <span>العروض</span></a>
                            <ul>
                                <li><a href="app-inbox.html"> أضافة عرض</a></li>
                                <li><a href="app-inbox.html">عرض الكل</a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <ul class="right_chat list-unstyled">
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{ asset('/theme-assets/images/xs/avatar4.jpg') }}" alt="">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{ asset('/theme-assets/images/xs/avatar5.jpg') }}" alt="">
                                <div class="media-body">
                    ...
                    <li class="offline">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{ asset('/theme-assets/images/xs/avatar2.jpg') }}" alt="">
                                <div class="media-body">
                    ...
                    <li class="offline">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{ asset('/theme-assets/images/xs/avatar1.jpg') }}" alt="">
                                <div class="media-body">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object" src="{{ asset('/theme-assets/images/xs/avatar3.jpg') }}" alt="">
                                <div class="media-body">
