            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">الشكاوي والاقترحات</li>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card planned_task">
                    <div class="header">
                        <p class="page_title">جميع الشكاوي والاقترحات</p>
                    </div>
                            ...
                            <table class="table m-b-0">
                                ...
                                @foreach($complaints as $msg)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/website/complaint/{{ $msg->id }}" method="post">
                                                @csrf
                                                @method("DELETE")
                                                <button
...
@section('script')
    ...
    <script src="{{ asset('/js/complaintConfig.js') }}"></script>
