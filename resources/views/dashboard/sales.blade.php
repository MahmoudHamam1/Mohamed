...
@section('style')
<link rel="stylesheet" href="{{ asset('/theme-assets/vendor/jvectormap/jquery-jvectormap-2.0.3.min.css') }}">
<link rel="stylesheet" href="{{ asset('/theme-assets/vendor/morrisjs/morris.min.css') }}">
@endsection
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"></a>لــــوحة التحكم</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item active">مبيعــات</li>
                    </ul>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled team-info margin-0">
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar1.jpg') }}" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar6.jpg') }}" title="Avatar" alt="Avatar"></li>
                                        </ul>
                                    </td>
                                    <td>$ 356</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled team-info margin-0">
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar1.jpg') }}" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar5.jpg') }}" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar9.jpg') }}" title="Avatar" alt="Avatar"></li>
                                        </ul>
                                    </td>
                                    <td>$ 542</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled team-info margin-0">
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar3.jpg') }}" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{ asset('/theme-assets/images/xs/avatar2.jpg') }}" title="Avatar" alt="Avatar"></li>
                                        </ul>
                                    </td>
                                    <td>$ 542</td>
                                </tr>
...
@section('script')
    ...
    <script src="{{ asset('/template-assets/bundles/jvectormap.bundle.js') }}"></script>
    <script src="{{ asset('/template-assets/bundles/knob.bundle.js') }}"></script>
    <script src="{{ asset('/template-assets/bundles/morrisscripts.bundle.js') }}"></script>

    <script src="{{ asset('/template-assets/bundles/mainscripts.bundle.js') }}"></script>
    <script src="{{ asset('/template-assets/js/index8.js') }}"></script>
@endsection
