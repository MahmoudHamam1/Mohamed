...
<link rel="stylesheet" href="{{ asset('/theme-assets/vendor/chartist/css/chartist.min.css') }}">
<link rel="stylesheet" href="{{ asset('/theme-assets/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css') }}">
@endsection
                        ...
                        <div class="cwidget-scroll">
                            <ul class="chat-widget m-r-5 clearfix">
                                <li class="left float-left">
                                    <img src="{{ asset('/theme-assets/images/xs/avatar2.jpg') }}" class="rounded-circle" alt="">
                                    <div class="chat-info">
                                        <span class="message">Hello, John<br>What is the update on Project X?</span>
                                    </div>
                                </li>
                                <li class="right">
                                    <img src="{{ asset('/theme-assets/images/xs/avatar1.jpg') }}" class="rounded-circle" alt="">
                                    <div class="chat-info">
                        ...
                        <div class="timeline-item blue">
                            ...
                            <div class="msg">
                                ...
                                <div class="timeline_img m-b-20">
                                    <img class="w-25" src="{{ asset('/theme-assets/images/blog/blog-page-4.jpg') }}" alt="Awesome Image">
                                    <img class="w-25" src="{{ asset('/theme-assets/images/blog/blog-page-2.jpg') }}" alt="Awesome Image">
                                </div>
                                <a href="javascript:void(0);" class="m-r-20"><i class="icon-heart"></i> Like</a>
...
@section('script')
    ...
    <script src="{{ asset('/template-assets/bundles/chartist.bundle.js') }}"></script>
